    ...
    <div class="container mt-5">
        ...
        <form action="index.php" method="post" class="card p-4">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="ip" name="ip" placeholder="Ej: 192.168.10.5" required>
            </div>
            <div class="mb-3">
                <label for="cidr" class="form-label">Prefijo CIDR</label>
                <input type="number" class="form-control" id="cidr" name="cidr" min="0" max="32" placeholder="Ej: 24" required>
            </div>
